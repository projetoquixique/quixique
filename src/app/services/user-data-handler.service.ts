...
export class UserDataHandlerService {
	constructor(){} 
 	...
 	newArtesao(){
 		let model = {tipo:"artesao", nome:undefined, cpf:undefined, dataDeNascimento:undefined, naturalidade:undefined, email:undefined, telefone:undefined, 
 	...
 	newArtesaoVerifiers(){
 		let verifiers = {nome:{estado:undefined, mensagem:""}, cpf:{estado:undefined, mensagem:""}, dataDeNascimento:{estado:undefined, mensagem:""}, naturalidade:{estado:undefined, mensagem:""}, email:{estado:undefined, mensagem:""}, telefone:{estado:undefined, mensagem:""},
 	...
 	newCliente(){
 		let model = {tipo:"cliente", nome: undefined, dataDeNascimento: undefined, cpf: undefined, email: undefined, telefone: undefined, 
                          cep: undefined, rua: undefined, numero:undefined, complemento: undefined, bairro: undefined, cidade: undefined, estado: undefined};
        return model;
 	};

 	newClienteVerifiers(){
 		let verifiers = {nome:{estado:undefined, mensagem:""}, dataDeNascimento:{estado:undefined, mensagem:""}, cpf:{estado:undefined, mensagem:""}, email:{estado:undefined, mensagem:""}, telefone:{estado:undefined, mensagem:""},
